                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">                    
                        <form name="createForm" @submit.prevent="submit">
                                    ...
                                    <div v-for="(question , index) in form.questions" :key="index" class="mb-4">
                                        <div>
                                                ...
                                                <div v-if="question.answers.length > 0" class="answers p-6">
                                                    ...
                                                    <div class="block mt-4">
                                                        <div class="flex justify-between">
                                                            ...
                                                            <div>
                                                                <button class="text-stone-500 border border-stone-500 hover:bg-stone-500 hover:text-white active:bg-stone-600 font-bold rounded outline-none focus:outline-none ease-linear transition-all duration-150 text-sm"  @click.prevent="removeAnswer(number)">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                                                                    </svg>
                                                                </button>            
                                            ...
                                            <div class="flex justify-between">
                                                ...
                                                <button v-if="form.questions[index].answers.length >= 3 && form.questions.length == index + 1" @click.prevent="newQuestion(number)" class="px-6 py-2 text-white bg-green-500 rounded-md focus:outline-none"> add question </button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div v-if="form.questions.length >= 1" class="mt-4 flex justify-end">
                                    <button
                                        type="submit"
