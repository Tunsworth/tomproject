                        ...
                        <form name="createForm" @submit.prevent="submit">
                                <div className="flex flex-col">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <select v-model="form.category_id" class="mt-1 block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
